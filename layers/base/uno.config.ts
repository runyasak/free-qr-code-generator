...
export default defineConfig({
  ...
  shortcuts: [
    ...
    ['base-button', 'text-main-bg not-disabled:bg-primary px-6 py-4 rounded-md border-0 uppercase font-bold my-transition md:text-xl cursor-pointer disabled:cursor-not-allowed disabled:bg-gray-500/50'],
